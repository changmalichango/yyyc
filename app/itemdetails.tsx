...
export default function ItemDetailsScreen() {
    ...
    const { title, price, image, rate } = useLocalSearchParams();
    return (
        <SafeAreaView style={[styles.safe, themeColor]}>
                ...
                <ScrollView style={styles.container}>
                    ...
                    <Text style={[styles.price]}>${price} per {rate}</Text>
                    ...
                    <Text style={[styles.description, textColor]}>
                        ...
                        Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt moll ahslkjdfhlkjlasdjhkgfbljkabdfgljkbalsdfkgblhbsdfglhblsd
                    </Text>
                ...
                <View style={[styles.bottomSection]}>
                    <View style={styles.chatBox}>
                        <Image source={require("../assets/images/chaticon.jpg")} style={styles.chatIconImage}/>
